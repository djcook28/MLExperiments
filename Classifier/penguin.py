...
class Penguin(Classify):
    def __init__(self):
        ...
        # as determined in the pairplot bill and flipper length are good indicators for species classification
        # accordingly creating data frames
    ...
    # utilizes the classify classes split train test split function to create a split for species utilizing the bill
    # and flipper length data frames
    # class variable to ensure less accurate datasets are not used by the end user
    ...
    # utilizes the classify classes split train test split function to create a split for gender utilizing the body mass
    # and bill depth data frames
    # class variable to ensure less accurate datasets are not used by the end user
    ...
    # runs through a range of k values so end users can determine what is most appropriate k values
    # for use in the actual model
    ...
    # runs a kneighbor model using the k value determined by the end user and the data frames specified earlier for
    # determining species
